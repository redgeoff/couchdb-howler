  ...
  _createClass(Client, [{
    ...
    value: function _startHeartbeatChecker() {
      ...
      this._heartbeatChecker = setInterval(function () {
        ...
        if (new Date().getTime() - _this7._lastHeartbeatAt.getTime() > _this7._heartbeatMilliseconds * 2) {
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                ...
                disconnected = this._connected ? _sporks2.default.once(this._socket, 'disconnect') : Promise.resolve();
