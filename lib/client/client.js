  ...
  _createClass(Client, [{
        ...
        return regeneratorRuntime.wrap(function _callee19$(_context19) {
          while (1) {
            switch (_context19.prev = _context19.next) {
              case 0:
                return _context19.abrupt('return', this._emit('heartbeat'));
    ...
    value: function _startHeartbeatChecker() {
      ...
      this._heartbeatChecker = setInterval(function () {
        ...
        var expirationMs = Math.max(_this7._heartbeatMilliseconds * 2, 5000);
        if (new Date().getTime() - _this7._lastHeartbeatAt.getTime() > expirationMs) {
          ...
          while (1) {
            switch (_context20.prev = _context20.next) {
              case 0:
                ...
                return _context20.abrupt('return', disconnected);
