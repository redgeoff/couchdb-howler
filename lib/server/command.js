...
var Command = function () {
  ...
  _createClass(Command, [{
    ...
    value: function _usage() {
      this._argv = _yargs2.default.usage('Usage: $0 [options]').example('$0 --port 3000').alias('p', 'port').nargs('p', 1).describe('p', 'Port').help('h').alias('h', 'help').epilog('Copyright 2017').argv;
    }
  }, {
    key: '_start',
    value: function () {
