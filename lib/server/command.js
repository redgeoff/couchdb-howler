...
var Command = function () {
  ...
  _createClass(Command, [{
    ...
    value: function _usage(argv) {
      this._argv = (0, _yargs2.default)(argv).usage('Usage: $0 [options]').example('$0 --port 3000').alias('p', 'port').nargs('p', 1).describe('p', 'Port').default('p', 3000).help('h').alias('h', 'help').version('v').alias('v', 'version').epilog('Copyright 2017').argv;
    }
  }, {
    key: '_start',
    value: function () {
