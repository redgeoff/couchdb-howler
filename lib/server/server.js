  ...
  _createClass(Server, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                this._logSocketInfo(socket, 'authentication failure=' + JSON.stringify(_context2.t0));
    ...
    value: function _onLogOut(socket) {
      ...
      socket.on('log-out', function (params, callback) {
        _this3._logSocketInfo(socket, 'logout, disconnecting...');
    ...
    value: function _listenToGlobalChanges() {
      ...
      this._iterator.each(function () {
        var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(change) {
          var dbName, sockets;
          return regeneratorRuntime.wrap(function _callee8$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  dbName = _this7._toDBName(change);
                  sockets = _this7._sockets.getByDBName(dbName);

                  // Are there any subscribers to this DB?

                  if (sockets) {
                    _sporks2.default.each(sockets, function (socket) {
                      _this7._logSocketInfo(socket, dbName + ' changed');
